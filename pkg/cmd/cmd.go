...
func init() {
	Command = &cli.Command{
		...
		Commands: []*cli.Command{
			...
			{
				Name:     "tag-manager-triggers",
				Category: "API RESOURCE",
				Suggest:  true,
				Commands: []*cli.Command{
					&tagManagerTriggersList,
					&tagManagerTriggersCreate,
					&tagManagerTriggersRetrieve,
					&tagManagerTriggersUpdate,
					&tagManagerTriggersDelete,
					&tagManagerTriggersTypes,
				},
			},
			{
				Name:     "tag-manager-variables",
				Category: "API RESOURCE",
				Suggest:  true,
				Commands: []*cli.Command{
					&tagManagerVariablesList,
					&tagManagerVariablesCreate,
					&tagManagerVariablesRetrieve,
					&tagManagerVariablesUpdate,
					&tagManagerVariablesDelete,
					&tagManagerVariablesTypes,
				},
			},
			{
				Name:     "tag-manager-folders",
				Category: "API RESOURCE",
				Suggest:  true,
				Commands: []*cli.Command{
					&tagManagerFoldersList,
					&tagManagerFoldersCreate,
					&tagManagerFoldersRetrieve,
					&tagManagerFoldersUpdate,
					&tagManagerFoldersDelete,
				},
			},
			{
